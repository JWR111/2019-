...
- 由於連續型變數仍有一個變數ANNUAL_PREMIUM_AMT缺失值比例占62%,因此考慮先使用隨機森林模型,並使用交叉驗證的方式,設定cross validation=5,看看有無加此變數的預測結果哪個較好
1. 有加ANNUAL_PREMIUM_AMT變數預測結果
2. 沒有加ANNUAL_PREMIUM_AMT變數預測結果
#### 處理離群值資料
- 
