...
- 等頻劃分
- 聚類劃分 
1. BANK_NUMBER_CNT<-20:0,BANK_NUMBER_CNT>=-20:1 
2. TERMINATION_RATE<-2.5:0,TERMINATION_RATE>=-2.5:1 
3. PAY_LIMIT_MED_MISC_AMT<-40:0,PAY_LIMIT_MED_MISC_AMT>=-40:1 
4. MONTHLY_CARE_AMT<-50:0,MONTHLY_CARE_AMT>=-50:1 
5. L1YR_GROSS_PRE_AMT<-200:0,L1YR_GROSS_PRE_AMT>=-200:1  
轉換後xgboost模型預測結果平均AUC值:0.837786
6. DIEBENEFIT_AMT<-5:0,DIEBENEFIT_AMT>=-5:1
7. DIEACCIDENT_AMT<-4.3:0,DIEACCIDENT_AMT>=-4.3:1
8. ACCIDENT_HOSPITAL_REC_AMT<-6:0,ACCIDENT_HOSPITAL_REC_AMT>=-6:1
9. DISEASES_HOSPITAL_REC_AMT<-6:0,DISEASES_HOSPITAL_REC_AMT>=-6:1
10. OUTPATIENT_SURGERY_AMT<-8:0,OUTPATIENT_SURGERY_AMT>=-8:1
11. INPATIENT_SURGERY_AMT<-8:0,INPATIENT_SURGERY_AMT>=-8:1  
...
8. 35個變數均值編碼後'LAST_C_DT', 'IF_S_REAL_IND', 'IF_Y_REAL_IND', 'IM_IS_A_IND', 'IM_IS_B_IND', 'IM_IS_C_IND', 'IM_IS_D_IND'等7個變數也改採均值編碼表示  
xgboost模型預測結果平均AUC值:0.843311
9. 35個變數均值編碼後'X_A_IND', 'X_B_IND', 'X_C_IND', 'X_D_IND', 'X_E_IND', 'X_F_IND', 'X_G_IND', 'X_H_IND', 'IF_HOUSEHOLD_CLAIM_IND'等8個變數也改採均值編碼表示 
xgboost模型預測結果平均AUC值:0.845044
10. 35個變數均值編碼後'IF_ISSUE_INSD_A_IND', 'IF_ISSUE_INSD_B_IND', 'IF_ISSUE_INSD_C_IND', 'IF_ISSUE_INSD_D_IND', 'IF_ISSUE_INSD_E_IND', 'IF_ISSUE_INSD_F_IND', 'IF_ISSUE_INSD_G_IND', 'IF_ISSUE_INSD_H_IND', 'IF_ISSUE_INSD_I_IND', 'IF_ISSUE_INSD_J_IND', 'IF_ISSUE_INSD_K_IND', 'IF_ISSUE_INSD_L_IND', 'IF_ISSUE_INSD_M_IND', 'IF_ISSUE_INSD_N_IND', 'IF_ISSUE_INSD_O_IND', 'IF_ISSUE_INSD_P_IND', 'IF_ISSUE_INSD_Q_IND'等17個變數也改採均值編碼表示
xgboost模型預測結果平均AUC值:0.844785
11. 35個變數均值編碼後'IF_ADD_INSD_F_IND', 'IF_ADD_INSD_L_IND', 'IF_ADD_INSD_Q_IND', 'IF_ADD_INSD_G_IND', 'IF_ADD_INSD_R_IND', 'IF_ADD_INSD_IND', 'CUST_9_SEGMENTS_CD'等7個變數也改採均值編碼表示
...
LIFE_CNT
- 
OCCUPATION_CLASS_CD	vs LEVEL	每種職業類別關係等級平均
OCCUPATION_CLASS_CD	vs AGE 
OCCUPATION_CLASS_CD	vs TOOL_VISIT_1YEAR_CNT
LEVEL vs TOOL_VISIT_1YEAR_CNT
AGE vs TOOL_VISIT_1YEAR_CNT
## 機器學習模型
#### xgboost
#### catboost
#### ensemble 
